...
public class GroupFacadeIntegrationTest {
  ...
  @Autowired private GroupFacade groupFacade;
  @Autowired private GroupRepository groupRepository;
  @Autowired private SuperGroupRepository superGroupRepository;
  @Autowired private SuperGroupTypeRepository superGroupTypeRepository;
  @Autowired private UserRepository userRepository;
  @Autowired private PostRepository postRepository;
  @Autowired private SettingsRepository settingsRepository;
  @Autowired private ClientAuthorityRepository clientAuthorityRepository;
  ...
  public void Given_Group_Expect_update_To_Work()
    ...
    GroupFacade.GroupWithMembersDTO groupDTO =
        this.groupFacade.getWithMembers(group.id().value()).orElseThrow();
    assertThat(groupDTO)
        .isEqualTo(
                ...
                group
                    ...
                    .groupMembers(
                        group.groupMembers().stream()
                            ...
                            //                                        .filter(groupMember ->
                            // !(groupMember.user().extended().locked() ||
                            // !groupMember.user().extended().acceptedUserAgreement()) )
                            .map(
                                groupMember ->
                                    new GroupMember(
  ...
  @Test
  public void Given_GroupWithNewMembers_Expect_setMembers_To_Work()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException,
          GroupRepository.GroupNameAlreadyExistsException {
    setAuthenticatedAsAdminUser(userRepository, adminRepository);
    ...
    List<GroupFacade.ShallowMember> newMembers =
        List.of(
            ...
            new GroupFacade.ShallowMember(
                u4.id().value(), treasurer.id().value(), "DubbelAnsvarig"),
    ...
    GroupFacade.GroupWithMembersDTO expectedGroupDTO =
        new GroupFacade.GroupWithMembersDTO(expectedGroup);
  ...
  private void addGroup(Group... groups)
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException,
          GroupRepository.GroupNameAlreadyExistsException {
