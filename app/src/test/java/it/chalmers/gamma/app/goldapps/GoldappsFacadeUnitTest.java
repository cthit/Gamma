...
class GoldappsFacadeUnitTest {
  ...
  @InjectMocks private GoldappsFacade goldappsFacade;
  ...
  public void getActiveUsersTest() {
    ...
    List<GoldappsFacade.GoldappsUserDTO> expectedActiveUsers =
        testCase.expectedActive.stream().map(GoldappsFacade.GoldappsUserDTO::new).toList();
  ...
  private ActiveSuperGroupsTestCase getActiveSuperGroupTestCase() {
    return new ActiveSuperGroupsTestCase(
        List.of(digit18, digit19, prit18, prit19, drawit18, drawit19, styrit18, styrit19),
        new ArrayList<>());
  }
  ...
  private ActiveUsersTestCase getActiveUsersTestCase() {
    ...
    return new ActiveUsersTestCase(
        List.of(digit18, digit19, prit18, prit19, drawit18, drawit19, styrit18, styrit19),
        List.of(u4, u6, u10, u11));
  }

  private record ActiveSuperGroupsTestCase(
      List<Group> groups, List<GoldappsFacade.GoldappsSuperGroupDTO> expectedSuperGroups) {}

  private record ActiveUsersTestCase(List<Group> groups, List<GammaUser> expectedActive) {}
}
