...
public final class DomainUtils {
  ...
  public static final Settings defaultSettings = new Settings(Collections.emptyList());
  ...
  public static final Post chair =
      new Post(PostId.generate(), 0, new Text("Ordförande", "Chairman"), new EmailPrefix("ordf"));
  public static final Post treasurer =
      new Post(PostId.generate(), 0, new Text("Kassör", "Treasurer"), new EmailPrefix("kassor"));
  public static final Post member =
      new Post(PostId.generate(), 0, new Text("Ledamot", "Member"), EmailPrefix.none());
  ...
  public static Group digit18 =
      g(
          "digit18",
          didit,
          List.of(gm(u1, chair, new UnofficialPostName("root")), gm(u2, treasurer)));
  public static Group prit18 =
      g(
          "prit18",
          sprit,
          List.of(
              gm(u1, chair, new UnofficialPostName("ChefChef")),
              gm(u1, treasurer),
              gm(u2, member)));
  public static GammaUser u3 = u("abcc", false, false);
  public static GammaUser u4 = u("abcd");
  public static Group digit19 =
      g("digit19", digit, List.of(gm(u3, chair), gm(u4, member), gm(u2, member)));
  public static GammaUser u5 = u("abce", false, false);
  public static GammaUser u6 = u("abcf");
  public static Group prit19 =
      g(
          "prit19",
          prit,
          List.of(
              gm(u5, chair),
              gm(u6, treasurer, new UnofficialPostName("Kas$$Chef")),
              gm(u6, member)));
  ...
  public static Group styrit18 =
      g("styrit18", emeritus, List.of(gm(u7, chair), gm(u8, member), gm(u9, member)));
  public static GammaUser u10 = u("abcj");
  public static GammaUser u11 = u("abck");
  public static Group digit17 =
      g("digit17", didit, List.of(gm(u11, chair), gm(u2, treasurer), gm(u4, member)));
  ...
  public static GroupMember gm(GammaUser u, Post p, UnofficialPostName unofficialPostName) {
    return new GroupMember(p, unofficialPostName, u);
  }
  ...
  public static GammaUser u(String cid, boolean locked, boolean gdprTrained) {
    return new GammaUser(
        ...
        Language.SV,
        new UserExtended(new Email(cid + "@chalmers.it"), 0, locked, null));
  }

  /** Basically adds 1 to each version since they all have been saved. Also removes extended. */
            ...
            .map(
                groupMember ->
                    new GroupMember(
                        ...
                        groupMember
                            .user()
                            .withExtended(groupMember.user().extended().withVersion(1))))
            .toList(),
        group.avatarUri(),
        group.bannerUri());
  }
  ...
  public static Authority asSaved(Authority authority) {
    return new Authority(
        authority.client(),
        authority.name(),
        authority.superGroups().stream().map(superGroup -> superGroup.withVersion(1)).toList(),
  ...
  public static void addAll(
      SuperGroupTypeRepository superGroupTypeRepository, SuperGroupType... types)
  ...
  public static Post p() {
    ...
    return new Post(
        PostId.generate(),
        0,
        new Text(postId + " - swedish", postId + " - english"),
