...
@ActiveProfiles("test")
@Import({UserActivationRepositoryAdapter.class, AllowListRepositoryAdapter.class})
public class UserActivationEntityIntegrationTests extends AbstractEntityIntegrationTests {
  ...
  @Autowired private AllowListRepository allowListRepository;
  ...
  @Test
  void Given_ValidCid_Expect_createActivationToken_To_CreateAValidUserActivationToken()
  ...
  @Test
  public void Given_ValidCid_Expect_removeActivation_To_Work()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
    Cid asdf = new Cid("asdf");
    ...
    assertThat(userActivationRepositoryAdapter.get(asdf)).isEmpty();
  }

  @Test
  public void Given_MultipleActivations_Expect_getAll_To_ReturnThem()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
    Cid cid1 = new Cid("asdf"), cid2 = new Cid("fdas"), cid3 = new Cid("lmao");
    ...
    assertThat(activations).extracting(UserActivation::token).doesNotHaveDuplicates();
  }

  @Test
  public void Given_ValidCid_Expect_get_To_ReturnCorrespondingActivation()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
  ...
  @Test
  public void Given_ValidCid_Expect_getByToken_To_ReturnCorrespondingActivation()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
    Cid cid1 = new Cid("asdf");
    ...
    assertThat(userActivationRepositoryAdapter.getByToken(userActivationToken)).isEqualTo(cid1);
  }
  ...
  @Test
  public void Given_InvalidCid_Expect_get_To_ReturnEmpty()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
    Cid cid1 = new Cid("asdf"), cid2 = new Cid("fdsa");
    ...
    assertThat(userActivationRepositoryAdapter.get(cid2)).isEmpty();
  }
  ...
  @Test
  public void Given_AnAlreadyActivatedCid_Expect_createActivationToken_To_GenerateANewToken()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
    Cid cid1 = new Cid("asdf");
    ...
    assertThat(token1).isNotNull().isNotEqualTo(token2);
  }

  @Test
  public void Given_InvalidCid_Expect_getByToken_To_Throw()
      throws AllowListRepository.AlreadyAllowedException,
          UserActivationRepository.CidNotAllowedException {
    Cid cid1 = new Cid("asdf");
    allowListRepository.allow(cid1);
    ...
    assertThatExceptionOfType(UserActivationRepository.TokenNotActivatedException.class)
        .isThrownBy(
            () -> userActivationRepositoryAdapter.getByToken(UserActivationToken.generate()));
  }
}
