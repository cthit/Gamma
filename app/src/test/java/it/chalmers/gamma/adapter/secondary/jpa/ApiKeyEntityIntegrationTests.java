...
class ApiKeyEntityIntegrationTests extends AbstractEntityIntegrationTests {
  ...
  @Autowired private ApiKeyRepositoryAdapter apiKeyRepositoryAdapter;

  @Autowired private ApiKeyJpaRepository apiKeyJpaRepository;

  @Autowired private ApiKeyEntityConverter apiKeyEntityConverter;
  ...
  public void Given_TwoApiKeys_Expect_create_To_Work()
    ...
    assertThat(apiKeyRepositoryAdapter.getAll()).hasSize(2);
  }

  @Test
  public void Given_TwoApiKeyWithSameId_Expect_create_To_Throw()
      throws ApiKeyRepository.ApiKeyAlreadyExistRuntimeException {
    ...
    assertThat(apiKeyRepositoryAdapter.getAll()).hasSize(1);
  }
  ...
  public void Given_ApiKey_Expect_delete_To_Work()
    ...
    assertThat(apiKeyRepositoryAdapter.getAll()).hasSize(0);
  }
  ...
  public void Given_AValidApiKey_Expect_resetApiKeyToken_To_Work()
    ...
    apiKeyRepositoryAdapter.create(
        new ApiKey(id, new PrettyName("what"), new Text("lmao", "lmao"), ApiKeyType.CLIENT, token));
    ...
    assertThat(apiKey).isNotNull().extracting(ApiKey::apiKeyToken).isEqualTo(newToken);
  }

  @Test
  public void Given_NoApiKeys_Expect_getAll_To_BeEmpty() {
    assertThat(apiKeyRepositoryAdapter.getAll()).isEmpty();
  }

  @Test
  public void Given_NoApiKeys_Expect_getById_To_BeEmpty() {
    assertThat(apiKeyRepositoryAdapter.getById(ApiKeyId.generate())).isEmpty();
  }

  @Test
  public void Given_NoApiKeys_Expect_getByToken_To_BeEmpty() {
    assertThat(apiKeyRepositoryAdapter.getByToken(ApiKeyToken.generate())).isEmpty();
  }

  @Test
  public void Given_AValidApiKey_Expect_getByToken_To_Work()
      throws ApiKeyRepository.ApiKeyAlreadyExistRuntimeException {
    ApiKeyToken token = ApiKeyToken.generate();
    ApiKey apiKey =
        new ApiKey(
    ...
    assertThat(apiKeyRepositoryAdapter.getByToken(token)).isNotEmpty().get().isEqualTo(apiKey);
  }

  @Test
  public void Given_AApiKey_Expect_toDomain_To_Work()
      throws ApiKeyRepository.ApiKeyAlreadyExistRuntimeException {
    ApiKey apiKey =
        new ApiKey(
            ApiKeyId.generate(),
    ...
    assertThat(converted).isEqualTo(apiKey);
  }
}
