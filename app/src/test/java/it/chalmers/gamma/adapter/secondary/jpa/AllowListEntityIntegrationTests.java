...
public class AllowListEntityIntegrationTests extends AbstractEntityIntegrationTests {
  ...
  @Autowired private AllowListRepositoryAdapter allowListRepositoryAdapter;
  ...
  public void Given_Cid_Expect_allow_To_Work() {
    ...
    assertThatNoException().isThrownBy(() -> allowListRepositoryAdapter.allow(cid));
  }
  ...
  public void Given_AllowedCid_Expect_remove_To_Work()
    ...
    assertThatNoException().isThrownBy(() -> allowListRepositoryAdapter.remove(cid));
  }
  ...
  public void Given_AllowedCid_Expect_isAllowed_To_Work()
    ...
    assertThat(allowListRepositoryAdapter.isAllowed(cid)).isTrue();
  }

  @Test
  public void Given_ManyAllowedCids_Expect_getAllowList_To_Work()
      throws AllowListRepository.AlreadyAllowedException {
