...
public class SuperGroupEntityIntegrationTests extends AbstractEntityIntegrationTests {
  ...
  @Autowired private SuperGroupRepositoryAdapter superGroupRepositoryAdapter;
  ...
  @Test
  public void Given_ValidSuperGroup_Expect_save_To_Work()
    ...
    assertThat(superGroupRepositoryAdapter.get(digit.id())).get().isEqualTo(digit.withVersion(1));
  }
  ...
  @Test
  public void Given_SameSuperGroup_Expect_save_To_Throw()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException {
    superGroupTypeRepository.add(committee);
    superGroupRepositoryAdapter.save(digit);
  ...
  @Test
  public void Given_ValidSuperGroup_Expect_delete_To_Work()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException,
          SuperGroupRepository.SuperGroupNotFoundException,
          SuperGroupRepository.SuperGroupIsUsedException {
    superGroupTypeRepository.add(committee);
    superGroupRepositoryAdapter.save(digit);

    assertThat(superGroupRepositoryAdapter.get(digit.id())).isPresent();

    superGroupRepositoryAdapter.delete(digit.id());

    assertThat(superGroupRepositoryAdapter.get(digit.id())).isEmpty();
  }
  ...
  @Test
  public void Given_MultipleSuperGroup_Expect_getAll_To_Work()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException {
    superGroupTypeRepository.add(committee);
  ...
  @Test
  public void Given_MultipleSuperGroup_Expect_getAllByType_To_Work()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException {
    superGroupTypeRepository.add(committee);
    superGroupTypeRepository.add(society);
    superGroupTypeRepository.add(alumni);
  ...
  @Test
  public void Given_SuperGroupThatIsUsed_Expect_delete_To_Throw()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException,
