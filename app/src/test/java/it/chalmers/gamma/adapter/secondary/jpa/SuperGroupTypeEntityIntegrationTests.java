...
public class SuperGroupTypeEntityIntegrationTests extends AbstractEntityIntegrationTests {
  ...
  @Autowired private SuperGroupTypeRepositoryAdapter superGroupTypeRepositoryAdapter;
  ...
  public void Given_ValidType_Expect_save_To_Work() {
    ...
    assertThatNoException().isThrownBy(() -> superGroupTypeRepositoryAdapter.add(superGroupType));
  }

  @Test
  public void Given_ValidType_Expect_delete_To_Work()
    ...
    assertThat(superGroupTypeRepositoryAdapter.getAll()).isEmpty();
  }
  ...
  @Test
  public void Given_MultipleTypes_Expect_getAll_To_Work()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException {
  ...
  @Test
  public void Given_SameType_Expect_add_To_Throw()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException {
    superGroupTypeRepositoryAdapter.add(new SuperGroupType("committee"));
  ...
  @Test
  public void Given_TypeThatIsUsed_Expect_delete_To_Throw()
      throws SuperGroupTypeRepository.SuperGroupTypeAlreadyExistsException,
