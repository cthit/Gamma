...
public class ClientBootstrap {
  ...
  public void runOauthClient() {
    ...
    this.clientRepository.save(
        new Client(
            ...
            Arrays.stream(defaultOAuth2Client.scopes().split(","))
                ...
                .map(Scope::valueOf)
                .toList(),
            new ApiKey(ApiKeyId.generate(), prettyName, new Text(), ApiKeyType.CLIENT, apiKeyToken),
    ...
    LOGGER.info(
        "An API key was also generated with the client, it has the code: " + apiKeyToken.value());
    LOGGER.info("==========                  ==========");
  }
}
