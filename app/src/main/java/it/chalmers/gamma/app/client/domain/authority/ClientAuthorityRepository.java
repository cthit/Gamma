...
public interface ClientAuthorityRepository {
  ...
  void create(ClientUid clientUid, AuthorityName authorityName)
      throws ClientAuthorityAlreadyExistsException;

  void delete(ClientUid clientUid, AuthorityName authorityName)
  ...
  /**
   * Can be avoided if you check that supergroups and users actually exists. It happens when linking
   * an authority level with one of the above, and it is not found in database.
   */
