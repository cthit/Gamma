...
public class ClientApprovalsRepositoryAdapter implements ClientApprovalsRepository {
  ...
  public ClientApprovalsRepositoryAdapter(
  ...
  public List<GammaUser> getAllByClientUid(ClientUid clientUid) {
    List<UserApprovalEntity> userApprovalEntities =
        this.userApprovalJpaRepository.findAllById_Client_ClientUid(clientUid.value());

    return userApprovalEntities.stream()
