...
public class MyClientsController {
    ...
    public ModelAndView getMyClients(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest) {
    ...
    public static final class CreateUserClient {
        ...
        public CreateUserClient(String redirectUrl,
                            String prettyName,
    ...
    public ModelAndView getCreateUserClient(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest) {
        ModelAndView mv = new ModelAndView();
    ...
    public ModelAndView createUserClient(@RequestHeader(value = "HX-Request", required = true) boolean htmxRequest,
                                     CreateUserClient form,
                                     BindingResult bindingResult) {
        ModelAndView mv = new ModelAndView();

        ClientFacade.ClientAndApiKeySecrets secrets = this.clientFacade.createUserClient(new ClientFacade.NewClient(
                form.redirectUrl,
                form.prettyName,
                form.svDescription,
                form.enDescription,
