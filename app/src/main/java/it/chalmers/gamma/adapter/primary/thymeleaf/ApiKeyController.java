...
public class ApiKeyController {
    ...
    public record CreateApiKey(String prettyName, String svDescription, String enDescription, String keyType) {

    }

    @GetMapping("/api-keys/create")
    public ModelAndView getCreateApiKey(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest) {
        ModelAndView mv = new ModelAndView();
    ...
    public ModelAndView createApiKey(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest,
                                     CreateApiKey form,
                                     BindingResult bindingResult) {
        ModelAndView mv = new ModelAndView();

        ApiKeyFacade.CreatedApiKey apiKeyCredentials = this.apiKeyFacade.create(new ApiKeyFacade.NewApiKey(
                form.prettyName,
                form.svDescription,
                form.enDescription,
                form.keyType
