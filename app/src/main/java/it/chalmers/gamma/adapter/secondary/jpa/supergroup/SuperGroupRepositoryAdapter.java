...
public class SuperGroupRepositoryAdapter implements SuperGroupRepository {
  ...
  public SuperGroupRepositoryAdapter(
      SuperGroupJpaRepository repository,
  ...
  @Override
  public void delete(SuperGroupId superGroupId)
  ...
  private SuperGroupEntity toEntity(SuperGroup superGroup) {
    ...
    superGroupEntity.superGroupType =
        this.superGroupTypeJpaRepository.getById(superGroup.type().value());
