...
public class ForgotPasswordController {
    ...
    public ModelAndView getForgotPassword(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest) {
    ...
    public ModelAndView sendForgotPassword(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest,
                                           ForgotPassword form,
    ...
    public ModelAndView getFinalizeForgotPassword(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest) {
        ModelAndView mv = new ModelAndView();
    ...
    public record FinalizeForgotPassword(String email, String token, String password, String confirmPassword) {

    }

    @PostMapping("/forgot-password/finalize")
    public ModelAndView finalizeForgotPassword(@RequestHeader(value = "HX-Request", required = false) boolean htmxRequest,
        ...
        try {
            this.userResetPasswordFacade.finishResetPasswordProcess(form.email, form.token, form.password);
        } catch (UserResetPasswordFacade.PasswordResetProcessException e) {
