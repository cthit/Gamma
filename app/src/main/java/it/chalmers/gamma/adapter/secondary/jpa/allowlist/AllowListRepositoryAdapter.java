...
public class AllowListRepositoryAdapter implements AllowListRepository {
  ...
  private final PersistenceErrorState CID_ALREADY_ALLOWED =
      new PersistenceErrorState("g_allow_list_pkey", PersistenceErrorState.Type.NOT_UNIQUE);
  ...
  public List<Cid> getAllowList() {
    return this.allowListJpaRepository.findAll().stream()
