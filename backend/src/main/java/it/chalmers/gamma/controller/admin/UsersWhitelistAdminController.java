...
import it.chalmers.delta.requests.AddListOfWhitelistedRequest;
import it.chalmers.delta.requests.WhitelistCodeRequest;
import it.chalmers.delta.response.CIDAlreadyWhitelistedResponse;
import it.chalmers.delta.response.EditedWhitelistResponse;
import it.chalmers.delta.response.GetWhitelistResponse;
import it.chalmers.delta.response.GetWhitelistedResponse;
import it.chalmers.delta.response.InputValidationFailedResponse;
import it.chalmers.delta.response.MissingRequiredFieldResponse;
...
import it.chalmers.delta.response.WhitelistAddedResponse;
