...
public class AuthorityFinder {
    ...
    public List<GrantedAuthorityImpl> getGrantedAuthorities(UserId userId) {
        ...
        memberships.forEach(membership -> {
            authorities.add(new GrantedAuthorityImpl(AuthorityLevelName.valueOf(membership.group().name().value()), AuthorityType.GROUP));
            authorities.add(new GrantedAuthorityImpl(AuthorityLevelName.valueOf(membership.group().superGroup().name().value()), AuthorityType.SUPERGROUP));
        });
