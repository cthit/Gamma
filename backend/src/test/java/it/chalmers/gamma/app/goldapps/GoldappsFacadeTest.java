...
class GoldappsFacadeTest {
    ...
    private SuperGroup sg(String name, SuperGroupType type) {
    ...
    private Group g(String name, SuperGroup sg, List<GroupMember> members) {
        return new Group(
                GroupId.generate(),
                0,
                new Name(name),
    ...
    private GroupMember gm(User u, Post p) {
    ...
    private User u(String cid) {
        return u(cid, false, true);
    }

    private User u(String cid, boolean locked, boolean gdprTrained) {
        return new User(
                UserId.generate(),
                0,
                new Cid(cid),
    ...
    private static final SuperGroupType board = new SuperGroupType("committee");
    private static final SuperGroupType alumni = new SuperGroupType("alumni");
    private static final SuperGroupType society = new SuperGroupType("society");

    private static final Post chair = new Post(
            PostId.generate(),
            0,
            new Text(
                    "Ordförande",
    ...
    private static final Post treasurer = new Post(
            PostId.generate(),
            0,
            new Text(
                    "Kassör",
